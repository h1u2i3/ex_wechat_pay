defmodule ExWechatPay.Utils.Method do
  ...
  defp do_define_methods(method_map, required_methods,
                         all_fields_methods, request_methods)

  defp do_define_methods([], required_methods,
                         all_fields_methods, request_methods) do
    all_fields_methods =
      all_fields_methods ++ [quote do: def all_fields(_), do: []]

    required_methods =
      required_methods ++ [quote do: def required_methods(_), do: []]
    ...
    methods = quote do
      ...
      defp parse_response({:error, %HTTPoison.Error{reason: :close}},
                          path, body, cert) do
    ...
    required_methods ++ all_fields_methods ++
  ...
  defp do_define_methods([item | tail], required_methods,
                         all_fields_methods, request_methods) do
    ...
    do_define_methods(tail, required_methods ++ [required_method],
